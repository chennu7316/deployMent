...
export default function RequiredDocs() {
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <Main open={open}>
        <DrawerHeader />
        <div className="req_docs_data_table">
          <div className="req_docs_table_text">
            <h1>Required Documents</h1>
          </div>
          <div className="req_docs_table_btn">
            <Button
              variant="contained"
              color="primary"
              onClick={() =>
                router.push("/adminpage/pages/required_docs/req_docs_from")
              }
            >
              Add New
            </Button>
