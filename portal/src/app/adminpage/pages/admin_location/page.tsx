...
export default function AdminLocation() {
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <Main open={open}>
        <DrawerHeader />
        <div className="adm_loc_data_table">
          <div className="adm_loc_table_text">
            <h1>Location</h1>
          </div>
          <div className="adm_loc_table_btn">
            <Button
              variant="contained"
              color="primary"
              onClick={() =>
                router.push("/adminpage/pages/admin_location/admin_location_form")
              }
            >
              Add New
            </Button>
