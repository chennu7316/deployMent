...
export default function EngineCapacities() {
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <Main open={open}>
        <DrawerHeader />
        <div className="eng_cap_data_table">
          <div className="eng_cap_table_text">
            <h1>Engine Capacity</h1>
          </div>
          <div className="eng_cap_table_btn">
            <Button
              variant="contained"
              color="primary"
              onClick={() =>
                router.push("/adminpage/pages/engine_capacities/eng_cap_form")
              }
            >
              Add New
            </Button>
